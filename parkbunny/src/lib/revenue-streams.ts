...
export const STREAM_DEFAULTS: Record<StreamType, StreamMeta> = {
    ...
    SOLAR_PPA: {
        ...
        icon: 'Sun',
        image: '/solar-ppa.png',
        description: 'Solar PV, Battery Storage, and EV charging for your site — available as a fully-funded Power Purchase Agreement (zero CAPEX) or as a paid installation for maximum long-term savings.',
        bullets: [
            'Option 1 — PPA (Zero CAPEX): Free installation, fixed kWh tariff (£0.16–£0.20), ~30% bill reduction, 15–25 year terms',
            'Option 2 — Paid Install: Up to 80% grid reduction, ~7-year ROI, 500% return over system life',
            'Minimum requirements (PPA): CreditSafe score of 55, 25,000 kWh annual consumption, 20kW+ capacity (~35 panels)',
            ...
            'Includes battery storage and grid trading capability',
            'No impact on site ownership — not a "rent a roof" agreement',
            'Direct contribution to carbon reduction targets',
        ],
        isTextOnly: true,
        textDisplay: '~30% bill reduction (PPA) or up to 80% grid reduction (Paid)',
        statusLabel: 'Subject to Survey',
        isAlternative: true,
    },
    SOLAR_PV_PAID: {
